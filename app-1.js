...
function go(page){
  ...
  ['dashboard','tasks','calendar','attendance','leave','field','policy','training','assets','fixedassets','inventory','payreq','payroll','accounts','recurring','taskmon','employees','profile','branches','watemplates','bulkmsg','cards','cardstatus','suggest','mdinbox','ops','patients','crmperf'].forEach(function(p){ var el=$('page-'+p); if(el) el.classList.toggle('hidden',p!==page); });
  ...
  /* v(new) — Messaging: Bulk Message Send. Timely Message is a later phase. */
